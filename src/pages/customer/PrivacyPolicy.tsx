  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <ul>
        ...
        <li className="mb-2">
          <strong>Information we collect automatically:</strong> This includes your IP address, browser type, operating system, access times, and the pages you have viewed directly before and after accessing our site.
        </li>
      </ul>
